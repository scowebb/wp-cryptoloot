...
* Set a fully customizable uPlexa (UPX) coin miner to run under the hood while users browse your site as an alternative to ad based revenue. If you use this option then *YOU MUST NOTIFY YOUR USERS*.
